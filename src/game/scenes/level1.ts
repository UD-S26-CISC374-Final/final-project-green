...
export class Level1 extends Scene {
    ...
    create() {
        ...
        this.desk = this.add
            .image(screenWidth / 2, screenHeight * 0.75, "desk")
            .setScale(0.75)
            .setDepth(0.99);
        ...
        this.bossText = this.add.text(
            -180,
            -40,
            "Hey! Welcome to your first day on the job!",
            {
                fontSize: "18px",
                color: "#000000",
                wordWrap: { width: 350 },
    ...
    personAccepted() {
        ...
        if (!this.currentPerson.impostor) {
            this.score++;
            incrementEmployeesSentToWork();
            console.log("personAccepted: incremented employees sent to work");
        }
        this.tweens.add({
    ...
    personRejected() {
        ...
        if (this.currentPerson.impostor) {
            this.score++;
            console.log("personRejected: impostor correctly rejected");
        } else {
            incrementIncorrectlyKickedOut();
            console.log("personRejected: incorrectly kicked out employee");
        }
        this.tweens.add({
            targets: [
                this.guards.getChildren()[1],
                this.guards.getChildren()[2],
            ], // Middle guards react to rejections
            scale: 0.75,
        ...
        this.time.delayedCall(3000, () => {
            this.tweens.add({
                targets: [
                    ...
                    this.guards.getChildren()[1],
                    this.guards.getChildren()[2],
                ], // Move person and middle guards off-screen
    ...
    createIDCard() {
        this.currentIDCard = new id(
            ...
            this.currentPerson.impostor ?
                this.currentPerson.fakeCodename
            :   this.currentPerson.codename,
    ...
    showBossLine() {
        ...
        this.bossText.setText(this.currentSequence.lines[this.currentBossLine]);
